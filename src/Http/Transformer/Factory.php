...
namespace Amani64\Api\Transformer;

use Amani64\Api\Http\Request;
use Amani64\Api\Transformer\Adapter\Fractal;
use Closure;
...
class Factory
{
     ...
     *
     * @var \Amani64\Api\Contract\Transformer\Adapter
     */
    protected $adapter;
     ...
     * @param \Amani64\Api\Contract\Transformer\Adapter $adapter
     *
     * @return void
     */
    public function __construct(Container $container, Fractal $adapter)
    {
     ...
     *
     * @return \Amani64\Api\Transformer\Binding
     */
    public function register($class, $resolver, array $parameters = [], Closure $after = null)
    {
        $this->bindings[$class] = $this->createBinding($resolver, $parameters, $after);
     ...
     *
     * @param \Closure|\Amani64\Api\Contract\Transformer\Adapter $adapter
     *
     * @return void
     */
     ...
     *
     * @return \Amani64\Api\Contract\Transformer\Adapter
     */
