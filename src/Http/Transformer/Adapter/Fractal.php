...
namespace Amani64\Api\Transformer\Adapter;

use Amani64\Api\Http\Request;
use Amani64\Api\Transformer\Binding;
use App\Ship\Parents\Transformers\TikTimeJsonApiSerializer;
...
//        $manager->setSerializer(new TikTimeJsonApiSerializer(env('API_URL')));
     ...
     * @param \Amani64\Api\Http\Request        $request
     *
     * @return array
     */
    ...
    /**
     * Set the underlying Fractal instance.
     *
     * @param $fractal
     * @return void
     */
     ...
     *
     * @return \Amani64\Api\Transformer\Adapter\Fractal
     */
