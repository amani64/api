...
namespace Amani64\Api\Http\Response;

use Amani64\Api\Http\ApiResponse;
use Closure;
use ErrorException;
...
class Factory
{
     ...
     *
     * @return \Amani64\Api\Http\ApiResponse
     */
...
//        return new ApiResponse($collection, 200, [], $binding);
    }
...
//        return new ApiResponse($item, 200, [], $binding);
    }
    ...
    public function __call($method, $parameters)
    {
        if (Str::startsWith($method, 'with')) {
            ...
            return new ApiResponse($parameters[0]);
        }
