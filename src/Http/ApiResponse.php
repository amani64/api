...
namespace Amani64\Api\Http;

use ArrayObject;
use UnexpectedValueException;
use Illuminate\Http\JsonResponse;
use Amani64\Api\Transformer\Binding;

use Illuminate\Contracts\Support\Arrayable;
use Illuminate\Http\Response as IlluminateResponse;
use Illuminate\Events\Dispatcher as EventDispatcher;
use Amani64\Api\Transformer\Factory as TransformerFactory;
use Illuminate\Database\Eloquent\Model as EloquentModel;
use Illuminate\Database\Eloquent\Collection as EloquentCollection;
use Symfony\Component\HttpKernel\Exception\NotAcceptableHttpException;

class ApiResponse extends IlluminateResponse
{
    /**
     ...
     *
     * @var \Amani64\Api\Transformer\Binding
     */
    protected $binding;
     ...
     *
     * @var \Amani64\Api\Transformer\Factory
     */
     ...
     * @param int                            $status
     * @param array                          $headers
     * @param \Amani64\Api\Transformer\Binding $binding
     *
     * @return void
     */
     ...
     *
     * @return \Amani64\Api\Http\Response
     */
...
//    }
     ...
     *
     * @return \Amani64\Api\Http\Response\Format\Format
     */
     ...
     *
     * @param string                                 $key
     * @param \Amani64\Api\Http\Response\Format\Format $formatter
     *
     * @return void
     */
     ...
     *
     * @param \Amani64\Api\Transformer\Factory $transformer
     *
     * @return void
     */
     ...
     *
     * @return \Amani64\Api\Transformer\Factory
     */
